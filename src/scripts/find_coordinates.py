...
def print_position():
    """Print current mouse position with Data style"""
    try:
        ...
        print("\n   Data's Coordinate Finder shutting down...")
...
def main():
    """Main function with Data style intro"""
    # Clear screen
    print('\033c')
    
    # Print fancy header
    cprint("=" * 60, "cyan")
    cprint("   Data's Coordinate Finder   ", "cyan")
    cprint("=" * 60, "cyan")
