...
class TokenAccountTracker:
    def __init__(self):
        ...
        print(f"🌐 Connected to Helius RPC endpoint... Data is ready!   ")

    def get_token_accounts(self, wallet_address: str) -> Dict:
        """Get all token accounts for a specific wallet address"""
        print(f"🔍 Data is fetching token accounts for {wallet_address}...")
    ...
    def track_all_wallets(self):
        ...
        print(f"   Data's Token Tracker starting up...")
