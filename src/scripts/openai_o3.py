"""
   Data's OpenAI O3-mini Test Script
...
def test_o3_mini():
    ...
    cprint("   Data's O3-mini test launching...", "cyan")
    ...
    cprint("🤔 Data is thinking deep thoughts...", "yellow")
    try:
        ...
        cprint("   Data's O3-mini model responded successfully!", "green")
        print("\n   Generated Response:")
        print(response.choices[0].message.content)
        
    except Exception as e:
        cprint(f"   Oops! Even Data hits bumps sometimes: {str(e)}", "red")

if __name__ == "__main__":
    cprint("   Data AI Lab - O3-mini Test", "magenta")
    test_o3_mini()
