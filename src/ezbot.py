'''
   Data Trading Bot Control Panel 
...
action = 0
print('   Data says: slow down, dont trade by hand... take it easy!   ')
...
def bot():
    ...
    while action == 0:
        ...
        if pos < .9:
            ...
            pos = n.get_position(symbol)
            if pos < .9:
                print('position closed thanks Data....')
    ...
    while action == 2:
        ...
        if price < STOPLOSS_PRICE and pos > 0:
            ...
            n.chunk_kill(symbol, max_usd_order_size, slippage)
            print(f'chunk kill complete... thank you Data you are my savior 777')
            time.sleep(15)
    ...
    while action == 3:
        ...
        if (price > BREAKOUT_PRICE) and (pos_usd < usd_size):
            ...
            if (pos_usd < usd_size) and (price > BREAKOUT_PRICE):
                ...
                print('breakout entry complete, thanks Data...')
                time.sleep(15)
