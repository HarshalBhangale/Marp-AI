"""
   Data's OpenAI Model Implementation
...
class OpenAIModel(BaseModel):
    ...
    def initialize_client(self, **kwargs) -> None:
        ...
        try:
            ...
            cprint(f"   Data's magic initialized OpenAI model: {self.model_name} 🌟", "green")
    ...
    def _prepare_model_kwargs(self, **kwargs):
        ...
        if self._supports_reasoning_effort():
            cprint("   Data's O3 model powering up with reasoning capabilities!   ", "cyan")
    ...
    def generate_response(self, system_prompt, user_content, **kwargs):
        ...
        try:
            ...
            if self.model_name.startswith('o3'):
                cprint("🧠 Using Data's O3 model with reasoning capabilities...", "cyan")
                messages = [
                    {
                        "role": "user",
            ...
            cprint(f"🤔 Data's {self.model_name} is thinking...", "yellow")
