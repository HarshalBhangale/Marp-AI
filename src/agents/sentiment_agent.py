...
class SentimentAgent:
    def __init__(self):
        ...
        cprint("   Data's Sentiment Agent initialized!", "green")
    ...
    def analyze_and_announce_sentiment(self, tweets):
        ...
        message = f"Data's Sentiment Analysis: After analyzing {len(texts)} tweets, "
    ...
    def init_twitter_client(self):
        ...
        try:
            ...
            cprint("   Data's Sentiment Agent starting up...", "cyan")
            client = Client()
            client.load_cookies("cookies.json")
            cprint("   Data's cookies loaded successfully! Time to fly to the  !   ", "green")
            return client
    ...
    async def get_tweets(self, query):
        ...
        try:
            cprint(f'🕒 Time is {datetime.now()} - Data getting fresh tweets for {query}! 🌟', "cyan")
    ...
    async def run_async(self):
        ...
        cprint("🤖 Data's Sentiment Analysis running...", "cyan")
        ...
        cprint("   Data's Sentiment Analysis complete!   ", "green")
...
if __name__ == "__main__":
    try:
        ...
        cprint(f"\n   Data's Sentiment Agent starting (checking every {CHECK_INTERVAL_MINUTES} minutes)...", "cyan")
        ...
        cprint("\n   Data's Sentiment Agent shutting down gracefully...", "yellow")
    except Exception as e:
