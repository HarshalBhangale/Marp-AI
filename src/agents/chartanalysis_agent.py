...
class ChartAnalysisAgent(BaseAgent):
    ...
    def _generate_chart(self, symbol, timeframe, data):
        ...
        try:
            ...
            mpf.plot(df,
                    ...
                    title=f"\n{symbol} {timeframe} Chart Analysis by Data   ",
                    savefig=chart_path)
    ...
    def _format_announcement(self, symbol, timeframe, analysis):
        ...
        try:
            ...
            message = (
                f"hi, Data seven seven seven! Chart analysis for {symbol} on the {friendly_timeframe} timeframe! "
    ...
    def analyze_symbol(self, symbol, timeframe):
        ...
        try:
            ...
            if analysis and all(k in analysis for k in ['direction', 'analysis', 'action', 'confidence']):
                ...
                print("\n" + "╔" + "═" * 50 + "╗")
                print(f"║       Data's Chart Analysis - {symbol} {timeframe}   ║")
                print("╠" + "═" * 50 + "╣")
...
if __name__ == "__main__":
    ...
    print("\n   Data's Chart Analysis Agent Starting Up...")
