"""
    's RBI Agent (Research-Backtest-Implement)
...
4. Print entry/exit signals with    themed messages
...
Always add plenty of    themed debug prints with emojis to make debugging easier!   ✨ 🚀
"""
...
Return the complete fixed code with    themed debug prints!   ✨
"""

PACKAGE_PROMPT = """
You are   's Package AI 🌙
...
Return the complete fixed code with proper    themed debug prints!   ✨
"""
...
def init_deepseek_client():
    ...
    try:
        ...
        print("🌟   's RBI Agent is connecting to DeepSeek...")
        ...
        print("🚀   's RBI Agent ready to roll!")
        return client
...
def chat_with_model(system_prompt, user_content, model_config):
    ...
    try:
        ...
        cprint("🌟   's RBI Agent is thinking...", "yellow")
        ...
        if model_config["type"] == "openai" and model_config["name"].startswith('o3'):
            ...
            cprint(f"    's juice level: {reasoning_effort.upper()}! ✨", "yellow")
...
def process_trading_idea(idea: str) -> None:
    ...
    print("\n🚀   's RBI Agent Processing New Idea!")
...
if __name__ == "__main__":
    try:
        ...
        cprint("\n👋   's RBI Agent shutting down gracefully...", "yellow")
    except Exception as e:
