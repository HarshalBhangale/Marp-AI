...
class FundingArbAgent(BaseAgent):
    ...
    def __init__(self):
        """Initialize   's Funding Arbitrage Agent"""
    ...
    def _format_announcement(self, symbol, data, analysis):
        ...
        announcement = f"""
        Yo    seven seven seven! High funding arbitrage opportunity detected!
        ...
        {analysis['confidence']}
          ...
          's Funding Arbitrage Agent - Making that funding money! 🌙
        """
        return announcement
