"""
   Data's Funding Arbitrage Agent   
...
class FundingArbAgent(BaseAgent):
    ...
    def __init__(self):
        """Initialize Data's Funding Arbitrage Agent"""
    ...
    def _format_announcement(self, symbol, data, analysis):
        ...
        announcement = f"""
        Yo Data seven seven seven! High funding arbitrage opportunity detected!
        ...
        Data's Funding Arbitrage Agent - Making that funding money!   
        """
        return announcement
