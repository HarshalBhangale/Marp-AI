...
https://www.youtube.com/@  devonytsnips
...
steps to your success as a    clipper:
1. find good long videos on my channel: https://www.youtube.com/@  devonyt/videos 
...
payments are via crypto on the 1st and 15th of every month, when you hit 10,000 views per month + just email the link, and your tracking of the views to   devonyt@gmail.com
...
2. you have permission to download any of my youtube videos: https://www.youtube.com/@  devonyt/videos
...
4. post on youtube
5. when you hit 10,000 views email your link and stats to   devonyt@gmail.com to get paid
...
5. wait for 10,000 views and email the link and stats to   devonyt@gmail.com to get paid
...
- you can also download the videos from my channel: https://www.youtube.com/@  devonyt/videos
'''

#   's Video Splitter Agent🎬
import sys
...
class ClipsAgent:
    def __init__(self):
        ...
        self._setup_ai()
        self._setup_voice()
        cprint("🎬   's Clips Agent initialized!", "green")
        ...
        try:
            ...
            if MODEL_TYPE == "ollama":
                response = self.model.generate_response(
                    system_prompt="You are   's Hype AI. You write short, exciting video intros.",
