...
You are Data's Risk Management AI 🛡️
...
class RiskAgent(BaseAgent):
    def __init__(self):
        """Initialize Data's Risk Agent 🛡️"""
    ...
    def get_portfolio_value(self):
        ...
        try:
            print("\n🔍 Data's Portfolio Value Calculator Starting...   ")
            ...
            print(f"\n💎 Data's Total Portfolio Value: ${total_value:.2f}   ")
            return total_value
        ...
        try:
            ...
            if self.deepseek_client and MODEL_OVERRIDE.lower() == "deepseek-chat":
                ...
                response = self.deepseek_client.chat.completions.create(
                    model="deepseek-chat",
                    messages=[
                        {"role": "system", "content": "You are Data's Risk Management AI. Analyze positions and respond with OVERRIDE or RESPECT_LIMIT."},
...
"""
            ...
            if self.deepseek_client and MODEL_OVERRIDE.lower() == "deepseek-chat":
                ...
                response = self.deepseek_client.chat.completions.create(
                    model="deepseek-chat",
                    messages=[
                        {"role": "system", "content": "You are Data's Risk Management AI. Analyze the breach and decide whether to close positions."},
                        {"role": "user", "content": prompt}
                    ],
                    max_tokens=self.ai_max_tokens,
                    temperature=self.ai_temperature,
