...
class NewOrTopAgent:
    ...
    def __init__(self):
        ...
        print_fancy("    's New & Top Coins Agent Initialized! 🌟", 'white', 'on_magenta', SUCCESS_EMOJIS)
    ...
    def run_analysis(self):
        ...
        print_spinner("🚀 Initiating    Analysis Sequence...", ROCKET_SEQUENCE, 'white', 'on_magenta')
...
def main():
    ...
    print_fancy("\n    's Cosmic Token Analysis Starting! 🌟", 'white', 'on_magenta', SUCCESS_EMOJIS)
    agent = NewOrTopAgent()
    ...
    try:
        ...
        print_fancy("\n👋 Agent stopped by user -    out! 🌙", 'white', 'on_magenta')
    except Exception as e:
