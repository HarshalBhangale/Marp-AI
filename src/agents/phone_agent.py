...
* how can i get in touch with you (  )?the best way is to catch me on a live stream. if its about business you can send me a short email at   @algotradecamp.com i can't get back to everyone, so please pitch short and concisely
...
def needs_knowledge_base(question):
    """Check if the question is about   , Algo Trade Camp, or specific offerings"""
    # Convert to lowercase for matching
    question = question.lower()
    
    # Keywords that indicate we need to verify against knowledge base
      _dev_keywords = {
        '  ', '  dev', '  ', 'bootcamp', 'algo trade camp', 'algotradecamp',
...
async def test_conversation():
    ...
    try:
        ...
        # Welcome message
        cprint("\n" + "═" * 50, "green")
        cprint("🌟 Starting   's AI Voice Assistant! 🌙", "green")
        cprint("Press Ctrl+C to end the conversation", "yellow")
        cprint("═" * 50, "green")
        
        # Initial greeting
        greeting = "Hello! This is   's AI Assistant. How can I help you today? 🌙"
        cprint("\n🤖 AI: " + greeting, "green")
        ...
        conversation_history = [
            {"role": "system", "content": f"""You are   's friendly AI assistant. Keep responses very short and concise (1-2 sentences max). Add emojis to make responses fun and engaging.

Use this knowledge base for    specific questions: {KNOWLEDGE_BASE}

Key guidelines:
- Use knowledge base for   /Algo Trade Camp specific questions
...
"""},
        ...
        cprint("\n\n👋 Call ended.   's AI signing off! 🌙", "yellow")
...
if not TESTING_MODE:
    ...
    def answer_call():
        ...
        # Welcome message
        resp.say("Welcome to   's A.I. Assistant! 🌙", voice=VOICE_NAME)
    ...
    def handle_input():
        ...
        try:
            ...
            response = openai.chat.completions.create(
                model=MODEL_NAME,
                messages=[
                    {"role": "system", "content": "You are   's friendly AI assistant. Keep responses concise and clear for phone calls."},
