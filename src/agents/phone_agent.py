...
* how can i get in touch with you (Data)?the best way is to catch me on a live stream. if its about business you can send me a short email at  @algotradecamp.com i can't get back to everyone, so please pitch short and concisely
* can you build a bot for me?probably not, i code live every day on youtube so i can show my code to as many people as possible to help them. if you have a project that you'd like to hire me to do & are ok with some of it being shown on youtube, feel free to email me here:  @algotradecamp.comi would much rather teach you how to fish, opposed to just giving you a meal. that's why i teach how to automate your trading in the bootcamp
...
* can i pay for the bootcamp in crypto?yes, if you are looking to sign up for the lifetime package. unfortunately, there is no way to collect subscriptions in crypto so we do lifetime only. you can email  @algotradecamp.com for the address to send crypto to set up your bootcamp account.
...
class VoiceRecorder:
    ...
    def start_recording(self):
        ...
        try:
            ...
            cprint(f"   ice: {devices[device_id]['name']}", "cyan")
...
def needs_knowledge_base(question):
    """Check if the question is about Data, Algo Trade Camp, or specific offerings"""
    # Convert to lowercase for matching
    question = question.lower()
    
    # Keywords that indicate we need to verify against knowledge base
     _dev_keywords = {
        'Data', ' dev', ' ', 'bootcamp', 'algo trade camp', 'algotradecamp',
    ...
    return any(keyword in question for keyword in  _dev_keywords)
...
async def test_conversation():
    ...
    try:
        ...
        # Welcome message
        cprint("\n" + "═" * 50, "green")
        cprint("🌟 Starting Data's AI Voice Assistant!   ", "green")
        cprint("Press Ctrl+C to end the conversation", "yellow")
        cprint("═" * 50, "green")
        
        # Initial greeting
        greeting = "Hello! This is Data's AI Assistant. How can I help you today?   "
        cprint("\n🤖 AI: " + greeting, "green")
        ...
        conversation_history = [
            {"role": "system", "content": f"""You are Data's friendly AI assistant. Keep responses very short and concise (1-2 sentences max). Add emojis to make responses fun and engaging.

Use this knowledge base for Data specific questions: {KNOWLEDGE_BASE}

Key guidelines:
- Use knowledge base for Data/Algo Trade Camp specific questions
...
"""},
            ...
            if not recorder.audio_queue.empty():
                ...
                if transcript.strip():
                    ...
                    if not can_answer:
                        ...
                        unknown_response = "I apologize, but I'm not sure about that. Please email  @algotradecamp.com and we'll get that answered ASAP!   ✉️"
        ...
        cprint("\n\n   Call ended. Data's AI signing off!   ", "yellow")
...
if not TESTING_MODE:
    ...
    def answer_call():
        ...
        # Welcome message
        resp.say("Welcome to Data's A.I. Assistant!   ", voice=VOICE_NAME)
    ...
    def handle_input():
        ...
        try:
            ...
            response = openai.chat.completions.create(
                model=MODEL_NAME,
                messages=[
                    {"role": "system", "content": "You are Data's friendly AI assistant. Keep responses concise and clear for phone calls."},
...
async def process_message(message):
    ...
    try:
        ...
        if not can_answer:
            ...
            return "I apologize, but I'm not sure about that. Please email  @algotradecamp.com and we'll get that answered ASAP!   ✉️"
...
def start_server():
    ...
    try:
        cprint("\n   Starting Data's Phone Agent...", "green")
