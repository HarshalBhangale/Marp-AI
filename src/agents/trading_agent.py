...
Remember: 
- Data always prioritizes risk management! 🛡️
- Never trade USDC or SOL directly
- Consider both technical and strategy signals
"""

ALLOCATION_PROMPT = """
You are Data's Portfolio Allocation Assistant   
...
class TradingAgent:
    def __init__(self):
        ...
        print("🤖 Data's LLM Trading Agent initialized!")
...
{json.dumps(market_data['strategy_signals'], indent=2)}
            ...
            print(f"   Data's AI Analysis Complete for {token[:4]}!")
            return response
    ...
    def allocate_portfolio(self):
        ...
        try:
            ...
            message = self.client.messages.create(
                ...
                messages=[{
                    "role": "user", 
                    "content": f"""You are Data's Portfolio Allocation AI   
...
{{
    ...
    def execute_allocations(self, allocation_dict):
        ...
        try:
            print("\n   Data executing portfolio allocations...")
            ...
            print("🔧 Data suggests checking the logs and trying again!")
    ...
    def run_trading_cycle(self, strategy_signals=None):
        ...
        try:
            ...
            cprint("\n   Data's Trading Recommendations:", "white", "on_blue")
            ...
            if allocation:
                cprint("\n💼 Data's Portfolio Allocation:", "white", "on_blue")
            ...
            cprint("🔧 Data suggests checking the logs and trying again!", "white", "on_blue")

def main():
    """Main function to run the trading agent every 15 minutes"""
    cprint("   Data AI Trading System Starting Up!   ", "white", "on_blue")
    ...
    while True:
        try:
            ...
            cprint("\n   Data AI Agent shutting down gracefully...", "white", "on_blue")
            break
        except Exception as e:
