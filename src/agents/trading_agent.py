...
TRADING_PROMPT = """
You are   's AI Trading Assistant 🌙
...
ALLOCATION_PROMPT = """
You are   's Portfolio Allocation Assistant 🌙
...
class TradingAgent:
    def __init__(self):
        ...
        print("🤖   's LLM Trading Agent initialized!")
...
{json.dumps(market_data['strategy_signals'], indent=2)}
            ...
            print(f"🎯   's AI Analysis Complete for {token[:4]}!")
            return response
    ...
    def allocate_portfolio(self):
        ...
        try:
            ...
            message = self.client.messages.create(
                ...
                messages=[{
                    "role": "user", 
                    "content": f"""You are   's Portfolio Allocation AI 🌙
...
{{
    ...
    def run_trading_cycle(self, strategy_signals=None):
        ...
        try:
            ...
            cprint("\n📊   's Trading Recommendations:", "white", "on_blue")
            ...
            if allocation:
                cprint("\n💼   's Portfolio Allocation:", "white", "on_blue")
            ...
            cprint("🔧    suggests checking the logs and trying again!", "white", "on_blue")
