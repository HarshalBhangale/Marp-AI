...
class AccumulationManipulation(Strategy):
    """Data's Accumulation/Manipulation Strategy   """
    ...
    def init(self):
        print("   Data's Strategy Initializing...")
    ...
    def next(self):
        ...
        if (self.data.Volume[-1] > self.volume_ma[-1] * 1.5 and  # Volume spike
            ...
            print(f"💫 Data entering LONG position! Size: {pos_size:.3f}")

# Load data
print("   Loading Data's trading data...")
data = pd.read_csv('/Users/md/Dropbox/dev/github/ -dev-ai-agents-for-trading/src/data/rbi/BTC-USD-15m.csv')
