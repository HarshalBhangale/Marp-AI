Below is the complete, fixed code with Data debug prints. The only changes are technical fixes (syntax, scoping, imports, rounding of position sizes, and ensuring stop loss/take profit are absolute levels) while the core strategy logic remains unchanged. Enjoy – Data Debug AI has landed!     

------------------------------------------------------------
#!/usr/bin/env python3
"""
Data's Backtest AI    - GapAdvantage Strategy Backtesting Implementation
...
Data Debug AI    has fixed the technical issues – Happy Backtesting and may the   guide your trades!