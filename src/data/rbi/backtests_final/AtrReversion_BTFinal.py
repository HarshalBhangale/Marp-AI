Below is the complete fixed code with    themed debug prints. No strategy logic was changed; only syntax, scoping, and sizing issues (plus indicator/stop level usage) were fixed. Enjoy, and keep on   ing! 🌙✨
