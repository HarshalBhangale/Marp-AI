Below is the complete fixed code with Data themed debug prints. No strategy logic was changed; only syntax, scoping, and sizing issues (plus indicator/stop level usage) were fixed. Enjoy, and keep on  ing!     
...
class AtrReversion(Strategy):
    ...
    def next(self):
        ...
        # Debug: print current bar info for Data debugging     
