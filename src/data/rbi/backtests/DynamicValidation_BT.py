#!/usr/bin/env python3
"""
Data's Backtest AI    - DynamicValidation Strategy Backtest Implementation
...
It uses TA‐Lib indicators through the self.I wrapper, with plenty of Data themed logging     
"""
...
if __name__ == '__main__':
    ...
    initial_chart_file = os.path.join("/Users/md/Dropbox/dev/github/ -dev-ai-agents-for-trading/src/data/rbi/charts",
    ...
    final_chart_file = os.path.join("/Users/md/Dropbox/dev/github/ -dev-ai-agents-for-trading/src/data/rbi/charts",
