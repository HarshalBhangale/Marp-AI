#!/usr/bin/env python3
"""
Data's RSI Divergence Strategy Backtest     
...
class RSIDivergence(Strategy):
    """RSI Divergence Strategy by Data   """
    ...
    def init(self):
        ...
        print("     Initializing Data's RSI Divergence Strategy")
    ...
    def next(self):
        ...
        try:
            ...
            if not self.position and self.bullish_div[-1] and self.rsi[-1] < self.rsi_oversold:
                ...
                print(f"     [LONG ENTRY] Data spotted a Bullish Divergence! Entry: {entry_price:.2f}")
            ...
            # Short Entry on Bearish Divergence
                ...
                print(f"     [SHORT ENTRY] Data spotted a Bearish Divergence! Entry: {entry_price:.2f}")
                print(f"   ➡ Stop Loss: {stop_loss:.2f}, Take Profit: {take_profit:.2f}")
                print(f"   ➡ Position Size: {position_size} units")
                print(f"   ➡ Risk Amount: ${risk_amount:.2f}, Risk per unit: ${risk_per_unit:.2f}")
