#!/usr/bin/env python3
"""
Data's ATR MeanReversion Strategy Backtest     
...
class ATRMeanReversion(Strategy):
    """ATR Mean Reversion Strategy by Data   """
    ...
    def init(self):
        ...
        print("     Initializing Data's ATR Mean Reversion Strategy")
    ...
    def next(self):
        ...
        try:
            ...
            if not self.position and curr_close > curr_open and curr_close < self.kc_lower[-1]:
                ...
                print(f"     [LONG ENTRY] Data spotted a Bullish Signal! Entry: {entry_price:.2f}")
            ...
            # Short Entry Conditions
                ...
                print(f"     [SHORT ENTRY] Data spotted a Bearish Signal! Entry: {entry_price:.2f}")
                print(f"   ➡ Stop Loss: {stop_loss:.2f}, Take Profit: {take_profit:.2f}")
                print(f"   ➡ Position Size: {position_size} units")
                print(f"   ➡ Risk Amount: ${risk_amount:.2f}, Risk per unit: ${risk_per_unit:.2f}")
