Below is a complete Python file implementing the AccumulationManipulationDetector strategy with plenty of    debug prints. You can save this as, for example, “backtest_strategy.py” and run it. (Make sure you have installed backtesting, talib, pandas, numpy, etc.)

──────────────────────────────
#!/usr/bin/env python3
"""
  's Backtest AI   – AccumulationManipulationDetector Strategy
──────────────────────────────
This code:
  ...
  • Prints    themed debug messages at key events 🚀✨
...
# ────────────────────────────── Data Handling ──────────────────────────────
print("     Debug: Loading data from CSV …")
...
print("     Debug: Data loaded and cleaned!")
...
class AccumulationManipulationDetector(Strategy):
    ...
    def init(self):
        ...
        print("✨    Debug: Initialized SMA indicators.")
    ...
    def next(self):
        ...
        #    themed debug print for each new bar
        ...
        print(f"✨    Debug: Market Bias = {bias_str} (SMA9: {self.sma_short[-1]:.2f} vs SMA21: {self.sma_long[-1]:.2f})")
        ...
        if not self.position:
            ...
            if recent_max_range > 1.2 * avg_range:
                ...
                print("✨    Debug: Accumulation phase detected!")
            ...
            if bullish_bias and (self.data.Close[-1] <= fair_value_gap * 1.01):
                ...
                # Debug entry message with    emojis
                print("🚀     Entry Signal: BULLISH trade triggered!")
            ...
            print(f"✨    Debug: Trade is active. Monitoring position …")
...
print("🚀     Debug: Running initial backtest ...")
stats = bt.run()
print("✨    Debug: Initial backtest complete!")
print(stats)
...
print(f"🚀     Debug: Saving initial chart to {chart_file}")
...
print("🚀     Debug: Starting parameter optimization …")
...
print(f"🚀     Debug: Saving optimized chart to {opt_chart_file}")
...
6. Plenty of    themed debug messages (with emojis 🌙✨🚀) are printed.

Make sure the charts directory exists and that the file paths match your local environment. Enjoy backtesting and optimizing with   ’s Backtest AI!