Below is the complete Python script that implements the StochasticPhaseFilter strategy according to the instructions. Copy the code into (for example) a file named backtest_stochastic_phase_filter.py and run it. Enjoy the Data debugging messages!       
...
class StochasticPhaseFilter(Strategy):
    ...
    def next(self):
        ...
        # Data themed debug print for every new bar!
...
if __name__ == "__main__":
    print("     Data Backtest AI Initialized for StochasticPhaseFilter Strategy!")
    ...
    print("     Data Backtest AI process complete!     ")
────────────────────────────
...
• Plenty of debug prints with Data emojis are added to help trace every step of the backtest.
