...
if __name__ == '__main__':
    ...
    chart_file = os.path.join("/Users/md/Dropbox/dev/github/ -dev-ai-agents-for-trading/src/data/rbi/charts", f"{strategy_name}_chart.html")
    ...
    print("     Backtesting complete! Keep shining, Data!   ")
