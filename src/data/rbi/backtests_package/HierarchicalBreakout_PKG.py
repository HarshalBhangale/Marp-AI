Below is your complete, fixed code for Data’s HierarchicalBreakout strategy. All indicators are now calculated only using TA‑Lib (wrapped via self.I) with NO backtesting.lib usage – and plenty of Data themed debug prints to boot! Enjoy!     
...
Happy backtesting – may the Data spirit guide your trades!