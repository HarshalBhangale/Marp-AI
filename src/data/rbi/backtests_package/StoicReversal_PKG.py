Below is the complete fixed code. Note that ALL forbidden backtesting.lib references have been removed and indicator and crossover logic now use talib and pure array indexing with self.I() wrappers as required. Enjoy the    magic! 🌙✨
...
This version of the code ensures that there is NO usage of backtesting.lib and that all indicator and crossover logic comply with   ’s package standards. Happy backtesting! 🌙✨