Here is the fixed code with proper    themed debug prints and without any usage of backtesting.lib:

```python
#!/usr/bin/env python3
"""
  's ATR MeanReversion Strategy Backtest
...
def load_and_clean_data(filepath):
    print("🌙✨    is loading and cleaning the data... 🚀")
